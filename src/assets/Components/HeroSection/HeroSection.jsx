    ...
    <>
         <div className='bg-gradient-to-r from-amber-50 to-[rgb(250,235,215)] rounded-3xl w-[85vw] h-[70vh] mx-auto'>
           <div className='p-10 pb-0 flex gap-30'>
                <div className='w-[40vw] mt-20 max-xl:mt-10'>
                ...
                <div className='relative mt-10 max-xl:mt-5'>
                   <img className='absolute left-16 top-28 w-[7.5vw] ani-hero max-xl:top-26 max-xl:left-14' src="img/hero-img.png" alt="" />
                    <img className='w-[40vw] max-xl:w-[50vw] ani-hero-person' src="img/her0-1.png" alt="" />
                </div>

...
function Brand() {
  return (
    <>
      <div className='mt-20 p-10 pt-0 flex gap-10 justify-center items-center max-sm:flex-col-reverse max-sm:p-4'>
            ...
            <div className='w-[35vw] max-sm:w-[80vw]'>
             ...
             <div className=''>
             <video autoPlay muted loop className='w-[20vw] h-[40vh] max-sm:w-auto' src="img/ProductDetailVideo-2.mp4"></video>
            </div>
          </div>
    </>
  )
